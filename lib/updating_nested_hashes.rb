...
def add_characters
 ...
 epic_tragedy = {
  ...
  epic_tragedy[0][:additional_characters] = []
  prince = {:name => "Prince Escalus"}
  apothecary = {:name => "Apothecary"}
  
 epic_tragedy[0][:additional_characters] << prince
 epic_tragedy[0][:additional_characters] << apothecary
  puts epic_tragedy[0][:additional_characters]
